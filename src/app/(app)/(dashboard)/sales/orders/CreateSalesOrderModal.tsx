...
import { createOrder, type SalesOrder, type SalesLineInput } from '@/src/libs/actions/sales.actions'
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-3xl rounded-2xl bg-white shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-zinc-200 px-6 py-4">
          <div>
            <h2 className="text-lg font-semibold text-zinc-900">New Sales Order</h2>
            <p className="mt-0.5 text-sm text-zinc-500">Create a new sales order for a customer.</p>
          </div>
          <button
            type="button"
            onClick={handleClose}
