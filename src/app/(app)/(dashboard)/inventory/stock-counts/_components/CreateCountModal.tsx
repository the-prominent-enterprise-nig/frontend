...
import {
  CreateCountFormSchema,
  type CreateCountFormValues,
  COUNT_TYPE_LABELS,
...
type Props = {
  isOpen: boolean
  onClose: () => void
  onSubmit: (data: CreateCountFormValues) => Promise<ApiResponse<unknown>>
...
export default function CreateCountModal({
  ...
  async function handleFormSubmit(data: CreateCountFormValues) {
