...
/* Accounting's Receiving Reports list.
 *
 * Deliberately NOT the inventory ReceivingReportsTab. That one was redesigned
 * in #172 (Scenario 50) into the stat-card/full-bleed shell the Stock hub
 * wants; accounting asked to keep this original table. The two are separate
 * components rather than one with a `variant` prop because they share only
 * their data source — the hook below — and nothing of their layout.
 */
...
export default function ReceivingReportsTable({
  showAmounts = false,
