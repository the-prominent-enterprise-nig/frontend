...
- The five pre-existing issues above are real gaps independent of this scenario's own scope (RBAC seeding, stale fixtures, image/upload logic) — worth their own tickets, not silently absorbed into Scenario 29's closing-gap list.
